...
export default function AdvancedDataTable<T extends object>({
  ...
  // suppress unused-var warnings for startRecord; it's used implicitly below
  void startRecord;
          ...
          {topContent && (
            <div
              className={clsx(
                ...
                title || showMonthYearFilter ? 'sm:w-auto justify-end' : 'justify-between'
              )}
            >
              {topContent}
            </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between px-6 py-4 border-t border-slate-200 bg-white gap-4">
        ...
        <div className="flex items-center gap-4 text-sm text-slate-600">
          ...
          <div className="hidden sm:block">
            {totalRecords > 0 ? (
              <span>
                Showing{' '}
                <span className="font-semibold text-slate-800">{endRecord}</span> out of{' '}
        ...
        {totalPages > 0 && (
          <div className="flex items-center gap-1.5">
            ...
            <div className="flex items-center gap-1 mx-1">{renderPageChips()}</div>
