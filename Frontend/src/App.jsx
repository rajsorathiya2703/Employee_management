  ...
  return (
    <Routes>
      <Route path="/" element={<MainLayout />}>
        {/* Render a simple dashboard for the root path so it's not empty */}
        <Route index element={<div className="p-4"><h1 className="text-2xl font-bold text-slate-800">Dashboard</h1></div>} />
