...
async function main(): Promise<void> {
  ...
  const hashedPassword = await bcrypt.hash("Priya@123", 12);
  ...
  const existingRequests = await prisma.attendanceRequest.count({
    ...
    await prisma.expense.createMany({
      data: [
        ...
        },
        {
          ...
          date: new Date("2026-06-06"),
          siteName: "Nashik",
          amount: new Prisma.Decimal(499.0),
        ...
        // May 2026
        {
          ...
          siteName: "Bangalore",
          amount: new Prisma.Decimal(7200.0),
          category: "Travel - Air",
          expenseType: "AMOUNT_WISE",
        ...
        },
        {
          ...
          date: new Date("2026-05-14"),
          siteName: "Bangalore",
          amount: new Prisma.Decimal(3200.0),
        ...
        },
        {
          ...
          siteName: "Nashik",
          amount: new Prisma.Decimal(360.0),
          category: "Bike11 - petrol",
          expenseType: "UNIT_WISE",
          unit: "ltr",
          unitRate: new Prisma.Decimal(120.0),
          status: "PAID",
        },
        {
          expenseCode: "EXP5007",
          ...
          siteName: "Nashik",
          amount: new Prisma.Decimal(340.0),
        ...
        // April 2026
        {
          ...
          siteName: "Delhi",
          amount: new Prisma.Decimal(1100.0),
        ...
        },
        {
          ...
          siteName: "Nashik",
          amount: new Prisma.Decimal(750.0),
          category: "Medical",
          expenseType: "AMOUNT_WISE",
          status: "PAID",
        },
